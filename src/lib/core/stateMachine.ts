...
const TRANSITIONS: Record<RunState, RunState[]> = {
  CREATED: ["RESOLVING_IDENTITY", "CANCELLED", "FAILED_TERMINAL"],
  RESOLVING_IDENTITY: ["RESEARCHING", "REVIEW_NEEDED", "FAILED_RETRYABLE", "FAILED_TERMINAL", "CANCELLED"],
  RESEARCHING: ["VALIDATING", "REVIEW_NEEDED", "FAILED_RETRYABLE", "FAILED_TERMINAL", "CANCELLED"],
  ...
  REVIEW_NEEDED: ["RESEARCHING", "VALIDATING", "READY_FOR_REVIEW", "CANCELLED"],
  CREATING_DILIGENCE_PACK: ["WATCHING", "READY_FOR_REVIEW", "FAILED_RETRYABLE", "CANCELLED"],
  WATCHING: ["COMPLETED", "CANCELLED"],
  COMPLETED: [],
  FAILED_RETRYABLE: ["RESOLVING_IDENTITY", "RESEARCHING", "VALIDATING", "CANCELLED", "FAILED_TERMINAL"],
  FAILED_TERMINAL: [],
  CANCELLED: [],
};
